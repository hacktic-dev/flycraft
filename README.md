...
![Example FlyCraft dashboard](docs/images/example-dashboard.png)

*An example FlyCraft dashboard (supervised-readout run): Minecraft view, retina,
anatomical MaleCNS activity, and the live learning/readout panel.*
